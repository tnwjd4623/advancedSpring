package com.example.proxyproject.config.v2_dynamicproxy;

import com.example.proxyproject.app.v1.*;
import com.example.proxyproject.config.v2_dynamicproxy.handler.LogTraceBasicHandler;
import com.example.proxyproject.config.v2_dynamicproxy.handler.LogTraceFilterHandler;
